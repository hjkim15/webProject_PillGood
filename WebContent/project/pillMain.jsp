        ...
        <section class="section">
            <div class="container">
                <div class="search-wrap search-wrap-border">
                    <form id="prdForm" class="search-form" action="" method="get"><input id="searchCategory"
                            name="searchCategory" type="hidden" value="" />
                        <input id="choYn" name="choYn" type="hidden" value="N" />
                        <div class="search-group pd-lr-20 text-center mg-b-30">
                            ...
                            <button class="-100 btn btn-primary btn-success" data-search-category="PROD_NAME"
                                data-cho-yn="N">검색</button>
                        </div>
                        <div class="search-group pd-lr-20 text-center">
                            ...
                            <input id="choSung" name="choSung" type="hidden" value="" /><button
                                class="-100 btn btn-primary btn-success" data-search-category="PROD_NAME"
                                data-cho-yn="Y">검색</button>
                        </div>
                        <hr class="hr02 mg-b-40">
                        <input type="hidden" id="kor" value="kor" />
                        <div class="seclect-grup-wrap">
                            <div class="select-group-type01">
                                <p class="select-tit" for="test1"><label for="symptom">증상별 검색</label></p>
                                <!--symptom-->
                                ...
                                </select><button class="-100 btn btn-primary btn-success"
                                    data-search-category="symptom">검색</button>
                            </div>
                            <div class="select-group-type01 mg-l-30">
                                <p class="select-tit"><label for="efficacy">제형별 검색</label></p>
                                <!--efficacy-->
                        ...
                        <div id="grid">
                            <div class="prod-list">
                                <div class="col-3" data-prod-code="#">
                                    <a href="#none" class="img_area link aStyle">
                                        <img src="HeeJoss.jpg" alt="약 이미지 불러오기" class="pillImg" />
                                    </a>
                                    <div class="prod_info">
