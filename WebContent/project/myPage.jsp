	...
	<div class="container">
		...
		<div>
			...
			<form name="regFrm" method="post" action="memberUpdateProc.jsp">
				<div style="">
					<div class="col-md-8"
						style="width: 68% !important; float: right !important;">
						...
						<article class="blog-post">
							...
							<div class=" col-sm-10">
								<input type="text" name="birth"
									class="input-group-text col-sm-5" value="<%=bean.getBirth()%>"
									readonly />
								<p>생년월일은 수정이 불가합니다.</p>
					...
					out.println("checked ");%>
							...
							<div class="col-sm-3">
								<span class="input-group">새 비밀번호 확인</span> <input
									type="password" class="form-control" placeholder="다시 입력"
									name="NPswCheck" id="text3" value="" /> <input type="text"
