            ...
            <div class="col-md-4">
                <div class="position-sticky" style="top: 2rem;">
                    <div class="p-4 mb-3 bg-light rounded">
                        ...
                        <img class=" img-fluid mx-auto" src="main.jpg" width="200" height="200"></img>
            ...
            <div class="col-md-8">
                ...
                <article class="blog-post">
                    ...
                    <div class=" col-sm-3">
                        ...
                        <span class="input-group-text"><%=bean.getNickname() %></span>
                    </div>

                    <div class="col-sm-3">
                        <span class="input-group">새 닉네임</span>
                        <input type="text" class="form-control" placeholder="새 닉네임 입력" name="newNname" id="text1"
                            value="" required />
                    ...
                    <div class="col-sm-2">
                        <br>
                        <button class="w-100 btn btn-primary btn-dark" type="submit">중복 확인</button>
                    </div>
                    <hr>
                    ...
                    <div class="col-sm-4">
                        <div class="badge bg-info text-dark">
                            <input name="gender" type="radio" class="form-check-input" value="male" required>
                            <label class="form-check-label" for="gender">male</label>
                        </div>
                        <div class="badge bg-info text-dark">
                            <input name="gender" type="radio" class="form-check-input" value="female" checked required>
                    ...
                    <div class="col-sm-4">
                        <div class="badge bg-info text-dark">
                            <input name="memberType" type="radio" class="form-check-input " value="normal" checked
                                required>
                            <label class="form-check-label" for="memberType">일반</label>
                        </div>
                        <div class="badge bg-info text-dark">
                            <input name="memberType" type="radio" class="form-check-input " value="pharmacist" required>
                            <label class="form-check-label" for="memberType">약사</label>
                        </div>

                    </div>
                    <div class="col-sm-4">
                        <br>
                        <button class="w-100 btn btn-primary btn-dark" type="submit">약사 코드 확인</button>
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="password" class="form-control" placeholder="new password" name="NPsw" value=""
                            required />

                    </div>
                    <div class="col-sm-3">
                        <span class="input-group">새 비밀번호 확인</span>
                        <input type="password" class="form-control" placeholder="다시 입력" name="NPswCheck" value=""
                            required />

                    </div>
                    <div class="col-sm-4">
                        <br>
                        <button class="w-100 btn btn-primary btn-dark" type="submit">비밀번호 변경 확인</button>
                        <!--버튼 누르면 약사 코드 확인하는 프롬프트 창. 아니면 위에서 약사 버튼 선택하면 약사 코드 입력하는 칸 나타나도록.-->
                    </div>
                    ...
                    <div class=" col-sm-6">
                        ...
                        <span class="input-group-text"><%=bean.getEmail() %></span>
                    </div>

                    <div class="col-sm-6">
                        <span class="input-group">새 이메일</span>
                        <input type="email" class="form-control" placeholder="새 이메일 입력" name="newEmail" value=""
                            required />
                    ...
                    <div>
                        ...
                        %>
                        <span class="badge bg-info text-dark">두통</span>
                        <span class="badge bg-info text-dark">치통</span>
                        <span class="badge bg-info text-dark">생리통</span>
                    ...
                    <div>
                        <span class="input-group">기존 브랜드</span>
                        <span class="badge bg-info text-dark">녹십자</span>
                        <span class="badge bg-info text-dark">종근당</span>
                        <span class="badge bg-info text-dark">휴베스트제약</span>
                    ...
                    <div>
                        ...
                        <div class="badge bg-info text-dark">
                            <input type="checkbox" class="btn">
                            <label class="form-check-label">브랜드들</label>
                        </div>
                        <div class="badge bg-info text-dark">
                            <input type="checkbox" class="btn ">
                            <label class="form-check-label">다 적으면</label>
                        </div>
                        <div class="badge bg-info text-dark">
                            <input type="checkbox" class="btn">
                            <label class="form-check-label">이거</label>
                        </div>
                        <div class="badge bg-info text-dark">
                            <input type="checkbox" class="btn ">
                            <label class="form-check-label">개많음</label>
                        </div>
