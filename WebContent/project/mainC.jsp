         ...
         <div class="carousel-item active">
            ...
            <div class="container">
               <div class="carousel-caption text-start">
                  ...
                  <p>상세 내용 기재.</p>
                  <p>
                     <a class="btn btn-lg btn-outline-secondary" href="#">광고 링크/ 관련 링크</a>
                  </p>
               </div>
            </div>
         </div>
         <div class="carousel-item">
            ...
            <div class="container">
               <div class="carousel-caption">
                  ...
                  <p>상세 내용 기재.</p>
                  <p>
                     <a class="btn btn-lg btn-success" href="#">광고 링크/ 관련 링크</a>
                  </p>
               </div>
            </div>
         </div>
            ...
            <div class="card shadow-sm"
               ...
               <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                     <div class="btn-group">
                        <button type="button" class="btn btn-sm btn-success"><%=bean.getNickName()%></button>
                        <button type="button" class="btn btn-sm btn-success"
                           onClick="javascript:read('<%=num%>')">게시글 보기</button>
                     </div>
